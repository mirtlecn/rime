...
# 生成英文词典的所有词汇
def gen_en ():
    dict_paths = ["en_dicts/main.dict.yaml", "en_dicts/special.dict.yaml","en.custom.yaml"]
...
## 生成中文词典的所有词
def gen_cn():
    dict_paths = ["cn_dicts/8105.dict.yaml", "cn_dicts/han.dict.yaml","cn_dicts/special.dict.yaml","cn.custom.dict.yaml","cn_dicts/base.dict.yaml","cn_dicts/ext.dict.yaml","cn_dicts/tencent.dict.yaml","cn_dicts/others.dict.yaml","cn_dicts/name.dict.yaml", 'cn_dicts/classical.dict.yaml']
